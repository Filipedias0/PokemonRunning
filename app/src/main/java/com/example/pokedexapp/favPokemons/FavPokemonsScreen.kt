...
fun FavPokemonsScreen(
    ...
    val pokemonList : List<FavPokemon> by viewModel.getAllFavPokemonsObserver().observeAsState(initial = listOf())
    Surface(
        ...
        Column {
            ...
            PokemonList(navController = navController, pokemonList)
        }
    }
}
...
fun PokemonList(
    ...
    LazyColumn(contentPadding = PaddingValues(16.dp)){
        ...
        items(itemCount){
            ...
            Text(text = favPokemon[1].pokemonName)
